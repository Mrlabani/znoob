...
def login():
    ...
    r = session.post(login_url, headers=headers, data=payload)
    return r.json()
...
def extract_api():
    # Check if the link is passed as a query parameter or in the body of the request
    ...
    try:
        # Fetch the files and links for the folder
